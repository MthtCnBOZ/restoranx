...
async function POST(request) {
    try {
        ...
        const { name, description, price, basePrice, categoryId, hasStock, stockQuantity, image, ingredients, hasVariations, variationIds, noIndex } = body;
        // Validasyon
        if (!name) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
      ...
      `;
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ...
            product: {
                ...product[0],
                variations,
                category: product[0].categoryId && product[0].categoryName ? {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__5fd31fb4._.js.map