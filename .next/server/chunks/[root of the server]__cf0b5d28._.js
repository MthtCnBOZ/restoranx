...
"[project]/.next-internal/server/app/api/admin/categories/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
async function GET() {
    try {
        const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAuthSession"])();
        // Oturum kontrolü
...
async function POST(request) {
    try {
        ...
        const existingCategory = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].category.findUnique({
            where: {
                slug: data.slug
            }
        });
        ...
        categoryData.isIndexed = data.isIndexed !== false;
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__cf0b5d28._.js.map