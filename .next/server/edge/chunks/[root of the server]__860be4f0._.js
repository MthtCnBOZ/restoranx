...
async function middleware(request) {
    ...
    const isAuthRoute = request.nextUrl.pathname.startsWith("/giris") || request.nextUrl.pathname.startsWith("/kayit");
    // Admin paneli koruma
    if (isAdminPanel) {
        console.log("Admin panel erişimi kontrol ediliyor");
        if (!isAuthenticated) {
            console.log("Kullanıcı giriş yapmamış, giriş sayfasına yönlendiriliyor");
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$spec$2d$extension$2f$response$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/giris", request.url));
        }
