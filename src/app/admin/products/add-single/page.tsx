...
export default function AddSingleProductPage() {
  ...
  // Kategorileri ve extraları getir
  useEffect(() => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const productData = {
        ...
        hasVariations: false, // Tekil ürün için varyasyon yok
  ...
  return (
    <div className="flex flex-col gap-4 md:gap-6">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-2xl md:text-3xl font-bold">Yeni Tekil Ürün Ekle</h1>
      </div>
      ...
      <Card>
        <form onSubmit={handleSubmit}>
          <CardHeader>
            ...
            <CardDescription>
              Yeni bir tekil ürün eklemek için aşağıdaki bilgileri doldurun
            </CardDescription>
          </CardHeader>
